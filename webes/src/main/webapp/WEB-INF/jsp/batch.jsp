...
<head>
    ...
    <script src="/webes/resources/js/batch.js"></script>
    <style>
        span.match {
            background: #ffcdd2;
            color:#f44336;
...
<div class="nav">
    <div class="container">
        <div class="searchDiv">
            ...
            <button id="submit" class="icon" style="height:25px;width:4%;"><i class="fa fa-download"></i></button>
        </div>
    </div>
</div>
<div class="content">
	<div class="container" id="toHidden">
		<div class="row">
			...
			<p>基因（或蛋白或酶）</p><p>Try:</p>
			<p><span class="gene1">EGFR</span></p><p><span class="gene4">1956</span>(NCBI的geneID)</p>
			</div>
			<div class="try col-sm-4">
			<p>表型（或症状或疾病）</p><p>支持多表型检索，以分号分开，Try:</p>
			<p><span class="disease1">MESH:D000741</span>(MeSH ID)</p><p><span class="disease6">HP:0012327</span></p><p><span class="disease7">DOID:10488</span></p><p><span class="disease8">UMLS:C0003466</span></p><p><span class="disease9">SNOMEDCT_US:204712000</span></p><p><span class="disease10">OMIM:207500</span></p><p><span class="disease11">GTR:AN0098163</span></p><p><span class="disease12">ORDO:AN0510403</span>（罕见病）</p><p><span class="disease3">coronary disease</span>(疾病)</p><p><span class="disease4">Fever</span>(症状)</p><p><span class="disease5">Fatigue;anemia</span>(多表型)</p><p><span class="disease13">NBK11167</span></p><p><span class="disease14">16p11.2</span></p>
			</div>
			<div class="try col-sm-3">
			<p>药物（或化学物质或营养物质）</p><p>Try:</p>
			<p><span class="chemical1">MESH:D000432</span>(MeSH ID)</p><p><span class="chemical6">CasRN:53-59-8</span></p><p><span class="chemical7">DrugBank:DB00717</span></p><p><span class="chemical8">ChEBI:3897</span></p><p><span class="chemical9">PharmGKB:PA164779052</span></p><p><span class="chemical2">Digitoxin</span>(MeSH 名字)</p><p><span class="chemical3">Calcium</span>(营养)</p><p><span class="chemical4">Methanol</span>(化学物质)</p><p><span class="chemical5">Metformin</span>(药物)</p><p><span class="chemical10">PubChem_sub:46506425</span></p><p><span class="chemical11">TTD:DAP001246</span></p>
			</div>
		</div>
	</div>
